...
if(isset($_POST['btn']))
{
    ...
    $td=$_POST['td'];
        $sql="insert into contactus(Name,Email,Companyname,Contactnumber)
        values('$name','$email','$cname','$contact')";
					...
					<div class="pd-20 card-box mb-30">
						...
						<form  method="post">
							...
							<div class="form-group row">
								...
								<div class="col-sm-12 col-md-10">
									<input name="email" pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,}$" title="Enter valid email" 
