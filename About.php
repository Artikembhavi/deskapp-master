...
if(isset($_POST['btn']))
{
    ...
    {
        $sql="insert into about(image,name,work)
        values('$filename','$name','$work')";
				...
				<div class="sidebar-menu">
					<ul id="accordion-menu">
						...
						<li class="dropdown">
							...
							<ul class="submenu">
								<li><a href="about.php">Form Basic</a></li>
								<li>
					...
					<div class="pd-20 card-box mb-30">
						...
						<div class="form-group row">
							...
							<div class="form-group row">
						        ...
						        <div class="form-group row">
								<label class="col-sm-12 col-md-2 col-form-label">Work</label>
								<div class="col-sm-12 col-md-10">
									<input name="work"
										class="form-control"
										type="text"
