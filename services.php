...
if(isset($_POST['btn']))
{
    ...
    $filestore=$_FILES['file']['type'];
    $filestore="image/".$filename;
    if(move_uploaded_file($filetmpname,$filestore))
    {
        $sql="insert into services(Image,Title,Description)
        values('$filename','$text','$td')";
				...
				<div class="sidebar-menu">
					<ul id="accordion-menu">
						...
						<li class="dropdown">
							...
							<ul class="submenu">
								<li><a href="services.php">Form Basic</a></li>
								<li>
			...
			<div class="pd-ltr-20 xs-pd-20-10">
				<div class="min-height-200px">
					...
					<div class="pd-20 card-box mb-30">
						<div class="clearfix">
							<div class="pull-left">
								<h4 class="text-blue h4">services Forms</h4>
						...
						<div class="form-group row">
								<label class="col-sm-12 col-md-2 col-form-label">Select Image</label>
								<div class="col-sm-12 col-md-10">
									<input class="form-control" type="file"
									 placeholder="Choose file" name="file" required>	
								</div>
							</div>
							...
							<div class="form-group row">
						        ...
						        <div class="form-group row">
								<label class="col-sm-12 col-md-2 col-form-label">Text Description</label>
								<div class="col-sm-12 col-md-10">
									<input name="td"
										class="form-control"
										type="text"
							...
							<div class="form-group row">
								<div class="col-sm-12 col-md-10">
									<input class="btn btn-primary btn-sm scroll-click"
									rel="content-y"
									data-toggle="collapse"
									role="button"
									type="submit" 
