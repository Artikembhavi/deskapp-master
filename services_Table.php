					...
					<ul id="accordion-menu">
						...
						<li class="dropdown">
							...
							<ul class="submenu">
								...
								<li><a href="contactus.php">contactTable</a></li>
							</ul>
						</li>
						<li>
				...
				<div class="min-height-200px">
					...
					<div class="pd-20 card-box mb-30">
						<div class="clearfix mb-20">
							<div class="pull-left">
								<h4 class="text-blue h4">services Table</h4>
															</div>
...
<tr align=center>
    <td><?php echo $rw[0];?></td>
    <td><?php echo $rw[1];?></td>
    <td><img src="image/<?php echo $rw[2];?>" width=50 height=50 alt=""></td>
    <td><?php echo $rw[3];?></td>
	<td><a href="servicesupdate.php?id=<?php echo $rw[0];?>">Update</a></td>
    <td><a href="servicesdelete.php?id=<?php echo $rw[0];?>">Delete</a></td>
    <td><a href="services.php?id=<?php echo $rw[0];?>">Insert</a></td>
</tr>
<?php
}
?>
