					...
					<ul id="accordion-menu">
						...
						<li class="dropdown">
							...
							<ul class="submenu">
								...
								<li><a hreaf="contact_Table.html">Contact_Table</a></li>
							</ul>
						</li>
						<li>
...
<tr align=center>
    ...
    <td><?php echo $rw[3];?></td>
    <td><?php echo $rw[4];?></td>
    <td><a href="cupdate.php?id=<?php echo $rw[0];?>">Update</a></td>
    <td><a href="cdelete.php?id=<?php echo $rw[0];?>">Delete</a></td>
    <td><a href="contact.php?id=<?php echo $rw[0];?>">Insert</a></td>
</tr>
