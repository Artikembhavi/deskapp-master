				...
				<div class="sidebar-menu">
					<ul id="accordion-menu">
						...
						<li class="dropdown">
							...
							<ul class="submenu">
								<li><a href="services.php">Contact_Us</a></li>


								<li><a href="advanced-components.html">Advanced Components</a>
								</li>
						...
						<li class="dropdown">
							...
							<ul class="submenu">
								<li><a href="services_Table.php">services_Tables</a></li>
								<li><a href="careers_Table.php">Careers_Table</a></li>
								<li><a hreaf="contact_Table.php">Contact_Table</a></li>
							</ul>
						</li>
						<li>
...
<tr align=center>
    ...
    <td><?php echo $rw[4];?></td>
    <td><?php echo $rw[5];?></td>
    <td><a href="careersupdate.php?id=<?php echo $rw[0];?>">Update</a></td>
    <td><a href="careersdelete.php?id=<?php echo $rw[0];?>">Delete</a></td>
    <td><a href="careers.php?id=<?php echo $rw[0];?>">Insert</a></td>
</tr>
<?php
}
?>
