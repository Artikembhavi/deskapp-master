...
if(isset($_POST['btn']))
{
	...
	$mn=$_POST['mn'];
    $add=$_POST['add'];
        $sql="insert into careers(Name,Qualification,Email,Mobilenumber,Address)
        values('$name','$qn','$email','$mn','$add')";
				...
				<div class="sidebar-menu">
					<ul id="accordion-menu">
						...
						<li class="dropdown">
							...
							<ul class="submenu">
								<li><a href="srvices.php">Form Basic</a></li>
								<li>
						...
						<li class="dropdown">
							...
							<ul class="submenu">
								...
								<li><a href="careers_Table.php">Careers_Tables</a></li>
                                <li><a href="contact_Table.php">Contact_Tables</a></li>
							</ul>
						</li>
						<li>
							...
							<div class="form-group row">
								...
								<div class="col-sm-12 col-md-10">
									<input name="mn"
										class="form-control"
										type="tel"
										pattern="[0-9]{10}" title="Enter valid Mobile Number"
									required/>
